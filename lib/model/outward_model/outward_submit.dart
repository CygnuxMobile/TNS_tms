...
OutWardSubmit outWardSubmitFromJson(String str) => OutWardSubmit.fromJson(json.decode(str));

String outWardSubmitToJson(OutWardSubmit data) => json.encode(data.toJson());
...
class OutWardSubmit {
  ...
  factory OutWardSubmit.fromJson(Map<String, dynamic> json) => OutWardSubmit(
...
class Serial {
  ...
  Serial copyWith({
    ...
    String? docksf,
      ...
      Serial(
        bcserialNo: bcserialNo ?? this.bcserialNo,
        docksf: docksf ?? this.docksf,
      );
