...
class AnotherStepper extends StatelessWidget {
  ...
  const AnotherStepper({
    ...
    this.scrollPhysics,
    this.iconHeight = 20,
    this.iconWidth = 20, required this.widgetHeight, required this.widgetWidth,
  ...
  Widget _getPreferredStepper(BuildContext context, {required int index}) {
    if (stepperDirection == Axis.horizontal) {
      return HorizontalStepperItem(
        ...
        iconWidth: iconWidth, widgetHeight: widgetHeight, widgetWidth: widgetHeight,
      );
    } else {
      return VerticalStepperItem(
        ...
        iconHeight: iconHeight,
        iconWidth: iconWidth, widgetHeight: widgetHeight, widgetWidth: widgetWidth,
      );
    }
  }
}
